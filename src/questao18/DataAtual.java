...
public class DataAtual {
    public static void main(String[] args) {
        ...
        System.out.println("Digite apenas o ano de seu aniversário");
        int anoAniversario = leitura.nextInt();

        System.out.println("Por favor nos informe, também, a data hoje.");
        System.out.println("Dia:");
        int diaAtual = leitura.nextInt();
        System.out.println("Mês:");
        int mesAtual = leitura.nextInt();
        ...
        if (dataValida) {
            System.out.println("A data de nascimento está ok!");
            ...
            if (idadeAtual(diaAniversario, mesAniversario, anoAniversario, diaAtual, mesAtual, anoAtual) >= 0) {
                System.out.println("A sua idade atual é: " + idadeAtual(diaAniversario, mesAniversario, anoAniversario, diaAtual, mesAtual, anoAtual));
            }

        else{
                System.out.println("Dados inválidos para a data atual.");
            }
    ...
    public static int idadeAtual(int dia, int mes, int ano, int diaHoje, int mesHoje, int anoHoje){
        if ( mesHoje < mes || mesHoje == mes && diaHoje < dia){
            int idade = (anoHoje - ano) - 1;
            return idade;
        }
        else{
            int idade0 = anoHoje - ano;
            return idade0;
        }
